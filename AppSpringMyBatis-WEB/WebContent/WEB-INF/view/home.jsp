...
<body>
	...
	<br/>
	<a href="${pageContext.request.contextPath}/modificar-usuario.action">Modificar usuario</a>
	<br/>
	<a href="${pageContext.request.contextPath}/eliminar-usuario.action">Eliminar usuario</a>
	<br/>
	<a href="${pageContext.request.contextPath}/log-out.action">Log out</a>
</body>
</html>
</jsp:root>
