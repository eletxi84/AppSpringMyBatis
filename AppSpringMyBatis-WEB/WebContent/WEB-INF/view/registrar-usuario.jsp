...
<body>
	<form:form id="fRegistrarUsuario" method="post" modelAttribute="usuario-nuevo" action="${pageContext.request.contextPath}/registrar-usuario.action">
		<div>
			<form:input type="text" path="codigo" placeholder="Código" required="requiered"/>
			<br/>
